...
$pathToSaveFobProd = "\\sm-ap003\it\temp\objekt\fob\" + $ObjectFilter + "__" + $(get-date -Format "yyMMdd_HHmm") + ".fob"#//-f yyyy-MM-dd) 
$pathToSaveTxtProd = "\\sm-ap003\it\temp\objekt\" + $ObjectFilter + "__" + $(get-date -Format "yyMMdd_HHmm") + "_prod.txt"#//-f yyyy-MM-dd) 
$pathToSaveTxtDev = "\\sm-ap003\it\temp\objekt\" + $ObjectFilter + "__" + $(get-date -Format "yyMMdd_HHmm") + "_dev.txt"#//-f yyyy-MM-dd) 
